// NHS.UK cookie consent v0.5.3-alpha
/* eslint-disable */
!(function (t) {
    var n = {};
    function e(r) {
    ...
    function (t, n, e) {
        ...
        if (e(8)) {
            var r = e(30),
                ...
                Wt = function (t, n) {
                    return (
                        x(t) && t[mt] && 'symbol' != typeof n && n in t && String(+n) == String(n)
                    );
                },
                Dt = function (t, n) {
                ...
                Bt = function (t, n, e) {
                    return !(Wt(t, (n = y(n, !0))) && x(e) && m(e, 'value')) ||
                        m(e, 'get') ||
                        m(e, 'set') ||
                        e.configurable ||
            ...
            yt || ((B.f = Dt), (D.f = Bt)),
                u(u.S + u.F * !yt, 'Object', { getOwnPropertyDescriptor: Dt, defineProperty: Bt }),
                i(function () {
                    ht.call({});
                }) &&
                    (ht = pt =
                ...
                (t.exports = function (t, n, e, a) {
                    ...
                    m
                        ? ((v = e(function (t, e, r, o) {
                              ...
                              if (x(e)) {
                                  if (
                                      ...
                                      return mt in e ? Ft(v, e) : Mt.call(v, e);
                                  (i = e), (p = _t(r, n));
                                  var b = e.byteLength;
                                  if (void 0 === o) {
                              ...
                              for (h(t, '_d', { b: i, o: p, l: u, e: c, v: new H(i) }); l < c; )
                                  P(t, l++);
                          })),
                          (S = v.prototype = _(Ut)),
                          h(S, 'constructor', v))
                        : (i(function () {
                          ...
                          K(y !== Function.prototype ? O(b).concat(O(y)) : O(b), function (t) {
                              t in v || h(v, t, b[t]);
                          }),
                          (v.prototype = S),
                          r || (S.constructor = v));
    ...
    function (t, n, e) {
        ...
        function o() {
            ...
            return r
                ? (r.getAttribute('data-policy-url') && (t = r.getAttribute('data-policy-url')), t)
                : t;
        }
        function i(t) {
            ...
            function (t, n, e, l, h) {
                ...
                if (i(b)) {
                    for (p = c(t.length); p > m; m++)
                        if ((g = n ? y(u((v = t[m]))[0], v[1]) : y(t[m])) === s || g === f)
                            return g;
                } else
    ...
    function (t, n, e) {
        ...
        t.exports = function (t, n, e, v, d, g, b) {
            ...
            if (
                (A &&
                    (k = f(A.call(new t()))) !== Object.prototype &&
                    k.next &&
                    (s(k, w, !0), r || 'function' == typeof k[l] || u(k, l, p)),
                S &&
                    O &&
                    'values' !== O.name &&
                    ((_ = !0),
                ...
                if (((y = { values: S ? P : x('values'), keys: g ? P : x('keys'), entries: F }), b))
                    for (m in y) m in E || i(E, m, y[m]);
    ...
    function (t, n, e) {
        ...
        function z(t, n, e, r, o, i) {
            var u = p(+e);
            if (u + n > t[I]) throw S(m);
            for (var c = t[j]._b, a = u + t[N], s = r(+o), f = 0; f < n; f++)
                c[a + f] = s[i ? f : n - f - 1];
        }
        if (u.ABV) {
            if (
            ...
            (k = function (t) {
                f(this, k, 'ArrayBuffer');
                var n = p(t);
                (this._b = g.call(new Array(n), 0)), (this[I] = n);
            }),
                (x = function (t, n, e) {
                    f(this, x, 'DataView'), f(t, k, 'DataView');
                    var r = t[I],
                        o = l(n);
            ...
            def: function (t, n, e) {
                ...
                return (
                    i
                        ? (i.v = e)
                        : ((t._l = i =
                              { i: (o = p(n, !0)), k: n, v: e, p: (r = t._l), n: void 0, r: !1 }),
                          t._f || (t._f = i),
                          r && (r.n = i),
                          t[d]++,
                          'F' !== o && (t._i[o] = i)),
    ...
    function (t, n, e) {
        ...
        e(127);
        var r,
            o = (r = e(299)) && r.__esModule ? r : { default: r };
    ...
    function (t, n, e) {
        ...
        var r = e(1),
            ...
            X = function (t) {
                ...
                return (
                    !(this === G && o(B, t) && !o(U, t)) &&
                    (!(n || !o(this, t) || !o(B, t) || (o(this, R) && this[R][t])) || n)
                );
            },
            Z = function (t, n) {
            ...
            tt = function (t) {
                for (var n, e = t === G, r = I(e ? U : x(t)), i = [], u = 0; r.length > u; )
        ...
        V ||
            (c(
                (N = function () {
                    ...
                    return i && Y && q(G, t, { configurable: !0, set: n }), J(t);
                }).prototype,
                'toString',
                function () {
                    return this._k;
            ...
            (e(46).f = X),
            (P.f = tt),
            i && !e(30) && c(G, 'propertyIsEnumerable', X, !0),
            (v.f = function (t) {
                return J(p(t));
            })),
            ...
            'Math',
            {
                imul: function (t, n) {
                    ...
                    return (
                        0 |
                        (o * i +
                            ((((65535 & (e >>> 16)) * i + o * (65535 & (r >>> 16))) << 16) >>> 0))
                    );
                },
            },
        );
    ...
    function (t, n, e) {
        ...
        r(r.S, 'String', {
            raw: function (t) {
                for (
                    var n = o(t.raw), e = i(n.length), r = arguments.length, u = [], c = 0;
                    e > c;
            ...
            'Array',
            {
                from: function (t) {
                    ...
                    if (
                        ...
                        for (e = new p((n = a(h.length))); n > b; b++)
                            s(e, b, g ? d(h[b], b) : h[b]);
                    else
                        for (l = y.call(h), e = new p(); !(o = l.next()).done; b++)
                ...
                return !e && r && t.constructor === s && i
                    ...
                    : o(
                          v
                              ...
                              : f((r = t instanceof s) ? t.source : t, r && i ? a.call(t) : n),
                          e ? this : l,
                          s,
                      );
            };
            ...
            return [
                ...
                function (t, n) {
                    ...
                    for (var k, x = '', w = 0, S = 0; S < y.length; S++) {
                        m = y[S];
                        for (
                            var _ = String(m[0]), E = s(f(u(m.index), h.length), 0), O = [], P = 1;
                            P < m.length;
                            P++
                        )
                ...
                [
                    ...
                    function (t, n) {
                        ...
                        for (var k = 0, x = 0, w = []; x < h.length; ) {
                            ...
                            var S,
                                _ = a(y, p ? h : h.slice(x));
                            if (null === _ || (S = l(c(y.lastIndex + (p ? 0 : x)), h.length)) === k)
                                x = u(h, x, g);
                            else {
    ...
    function (t, n, e) {
        ...
        h &&
            p &&
            (a((r = s.getConstructor(b, 'WeakMap')).prototype, y),
            (c.NEED = !0),
        ...
        r(r.P, 'Array', {
            flatMap: function (t) {
                var n,
                    ...
                    r = i(this);
                return (
                    c(t), (n = u(r.length)), (e = a(r, 0)), o(e, r, r, n, 0, 1, t, arguments[1]), e
                );
            },
        }),
            e(36)('flatMap');
    ...
    function (t, n, e) {
        for (
            ...
            var g,
                ...
                m = u[b],
                k = m && m.prototype;
            if (k && (k[f] || c(k, f, h), k[l] || c(k, l, b), (a[b] = h), y))
    ...
    function (t, n, e) {
        var r = (function (t) {
            ...
            var m = Object.getPrototypeOf,
                k = m && m(m(F([])));
            k && k !== e && r.call(k, i) && (y = k);
            var x = (b.prototype = d.prototype = Object.create(y));
            function w(t) {
    ...
    function (t, n, e) {
        var r = e(86),
            ...
            a = function (t, n, e) {
                ...
                for (s in (p && (e = n), e))
                    ((f = !h && k && void 0 !== k[s]) && c(y, s)) ||
                        ((l = f ? k[s] : e[s]),
                        (y[s] =
                            p && 'function' != typeof k[s]
                                ? e[s]
                                : g && f
                                ? i(l, r)
                                : b && k[s] == l
    ...
    function (t, n, e) {
        t.exports =
            ...
            !e(121)(function () {
                return (
                    7 !=
                    Object.defineProperty(e(308)('div'), 'a', {
                        get: function () {
                            return 7;
                        },
                    }).a
    ...
    function (t, n, e) {
                ...
                (function (t, n) {
                    ...
                    try {
                        for (
                            ...
                            !(r = (u = c.next()).done) && (e.push(u.value), !n || e.length !== n);
                            r = !0
                        );
                    } catch (t) {
                        (o = !0), (i = t);
        ...
        function o(t, n, e, r, o, i) {
            ...
            u && (a += ';expires=' + u),
                r && (a += ';path=' + escape(r)),
                o && -1 !== o.indexOf('.') && (a += ';domain=' + escape(o)),
                i && (a += ';secure'),
                (a += ';'),
                (document.cookie = a);
        }
        ...
        function u() {
            var t = i(),
                ...
                u = window.location.pathname.replace(/\/$/, '').split('/'),
                c = u.map(function (t, n) {
                    return u.slice(0, n + 1).join('/') || '/';
                });
        ...
        function l(t) {
            ...
            (document.getElementById('cookiebanner').style.display = 'none'),
                ...
                (document.getElementById('nhsuk-cookie-confirmation-banner').style.display =
                    'block'),
                (n = document.getElementById('nhsuk-success-banner__message')).setAttribute(
                    'tabIndex',
                    '-1',
                ),
                n.focus(),
        ...
        var y = 3,
            m = 'nhsuk-cookie-consent',
            k = { LONG: 'long', SESSION: 'session' },
            x = !1,
            w = { necessary: !0, preferences: !1, statistics: !1, marketing: !1, consented: !1 };
        function S() {
            var t,
                n = ((t = m), i()[t] || null);
            return JSON.parse(n);
        ...
        function E(t) {
            var n,
                e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : k.LONG;
            if (e === k.LONG) n = 90;
            else {
                if (e !== k.SESSION && e)
                    throw new Error('Cookie mode '.concat(e, ' not recognised'));
                n = null;
            }
            !(function (t, n, e, r, i) {
        ...
        function O() {
            var t,
                n = null === (t = S()) ? null : t.version;
            return null === n ? null : n >= y;
        }
        function P(t) {
            return !!_()[t];
        }
        ...
        function A() {
            ...
            !(function (t) {
                for (
                    var n = document.querySelectorAll('script[data-cookieconsent]'), e = 0;
                    e < n.length;
                    e++
                ) {
                    p(t, n[e].getAttribute('data-cookieconsent')) && h(n[e]);
                }
            })(t),
                (function (t) {
                    for (
                        var n,
                            e,
                            r = document.querySelectorAll('iframe[data-cookieconsent]'),
                            o = 0;
                        o < r.length;
                        o++
                    ) {
                        p(t, r[o].getAttribute('data-cookieconsent')) &&
                            ((n = r[o]),
                            (e = void 0),
                            (e = n.getAttribute('data-src')),
        ...
        (window.NHSCookieConsent = {
            ...
            window.addEventListener('DOMContentLoaded', function () {
                var t, n, e;
                Object(v.getNoBanner)() ||
                    document.location.href ===
                        Object(v.makeUrlAbsolute)(Object(v.getPolicyUrl)()) ||
                    (null !== S() && O() && !1 !== P('consented')) ||
                    (x
                        ? E(
                              {
                                  necessary: !0,
