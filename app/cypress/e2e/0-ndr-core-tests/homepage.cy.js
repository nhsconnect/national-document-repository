...
describe('Home Page Tests', () => {
  ...
  it('displays expected page header on home page', () => {
    ...
    cy.get('.nhsuk-header__transactional-service-name--link').should('have.text', 'Inactive Patient Record Administration')
  ...
  it('displays correct page title on home page', () => {
    ...
    //ensure the page header is visable
    cy.get('.app-homepage-content h1').should('have.text', 'Inactive Patient Record Administration')
