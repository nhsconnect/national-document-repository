...
describe("<CompleteStage />", () => {
    describe("Show complete stage", () => {
        ...
        it("with successfully uploaded docs", async () => {
            ...
            const documentOne : UploadDocument = {file: buildTextFile("one", 100), progress: 0, state: documentUploadStates.FAILED, id: '1'};
            const documentTwo : UploadDocument = {file: buildTextFile("two", 200), progress: 0, state: documentUploadStates.SUCCEEDED, id: '2'};
            const documentThree :UploadDocument = {file: buildTextFile("three", 100), progress: 0, state: documentUploadStates.SUCCEEDED, id: '3'};
