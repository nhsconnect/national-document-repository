  ...
  const tableCaption = (
    <>
      ...
      <span className="nhsuk-error-message" id="example-error">
        <span className="nhsuk-u-visually-hidden">Error:</span> Documents that
  ...
  return (
    <section>
      ...
      <WarningCallout style={{ marginTop: 75 }}>
        ...
        <ul>
          <li>
            You could take a screenshot of this summary page and attach it to
            the patient&apos;s record
          </li>
          <li>
            When you have finished uploading, and the patient is deducted from
            your practice, delete all temporary files created for upload on your
            computer
          </li>
          <li>
            If you have accidentally uploaded incorrect documents, please
            contact Primary Care Support England (PSCE)
          </li>
        </ul>
      </WarningCallout>
    </section>
