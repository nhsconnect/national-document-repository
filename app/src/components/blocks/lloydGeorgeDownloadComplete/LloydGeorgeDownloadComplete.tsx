        ...
        <div className="lloydgeorge_download-complete">
            ...
            <>
                ...
                <ol>
                    ...
                    <li>
                        Ensure all access to the record is auditable, so information can be provided
                        about who accessed the record
                    </li>
                    <li>
                        If the patient moves practice, you must make sure the patient record safely
                        transfers to their new practice
                    </li>
                    <li>
                ...
                <p>
                    ...
                    responsibilities for creating, maintaining, and disposing of records
                    appropriately.
                </p>
