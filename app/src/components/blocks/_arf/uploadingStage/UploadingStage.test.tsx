...
describe('<UploadDocumentsPage />', () => {
    describe('with NHS number', () => {
        ...
        it('progress bar reflect the upload progress', async () => {
            ...
            triggerUploadStateChange(documentTwo, documentUploadStates.SCANNING, undefined);
            rerender(<UploadingStage documents={[documentOne, documentTwo, documentThree]} />);
            expect(getProgressText(documentTwo)).toContain('Virus scan in progress');

            triggerUploadStateChange(documentTwo, documentUploadStates.CLEAN, undefined);
            rerender(<UploadingStage documents={[documentOne, documentTwo, documentThree]} />);
            expect(getProgressText(documentTwo)).toContain('Virus scan complete');

            triggerUploadStateChange(documentTwo, documentUploadStates.SUCCEEDED, undefined);
            rerender(<UploadingStage documents={[documentOne, documentTwo, documentThree]} />);
            expect(getProgressText(documentTwo)).toContain('Upload succeeded');
        });
    });
