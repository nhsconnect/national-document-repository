...
MOCK_PDF_STITCHER_SQS_URL_ENV_NAME = "PDF_STITCHER_SQS_URL"
...
PDF_STITCHER_SQS_URL = (
    "https://sqs.us-east-1.amazonaws.com/977715257439/MyPdfStitcherQueue"
)
...
def set_env(monkeypatch):
    ...
    monkeypatch.setenv(MOCK_PDF_STITCHER_SQS_URL_ENV_NAME, PDF_STITCHER_SQS_URL)
