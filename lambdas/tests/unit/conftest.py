...
MOCK_METADATA_NRL_SQS_URL_ENV_NAME = "METADATA_NRL_SQS_URL"
...
METADATA_NRL_SQS_URL = "https://test-queue.com"
...
def set_env(monkeypatch):
    ...
    monkeypatch.setenv(MOCK_METADATA_NRL_SQS_URL_ENV_NAME, METADATA_NRL_SQS_URL)
