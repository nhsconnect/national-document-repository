...
def test_back_channel_logout_handler_jwt_without_session_id_returns_400(mocker, monkeypatch):
    mock_token = "mock_token"
    monkeypatch.setenv("SSM_PARAM_CIS2_BCL_PUBLIC_KEY", "mock_public_key")
...
def test_back_channel_logout_handler_boto_error_returns_400(mocker, monkeypatch):
    mock_token = "mock_token"
    mock_session_id = "mock_session_id"
    mock_decoded_token = {"sid": mock_session_id}
    monkeypatch.setenv("SSM_PARAM_CIS2_BCL_PUBLIC_KEY", "mock_public_key")
