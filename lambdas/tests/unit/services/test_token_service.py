...
def test_get_public_key_and_decode_auth_token(mocker):
    ...
    mocker.patch("services.ssm_service.SSMService.get_ssm_parameter", return_value="test_value_param_key")
    token_service = TokenService()
    response = token_service.get_public_key_and_decode_auth_token(auth_token="token_test",
                                                                  ssm_public_key_parameter="param_key")
