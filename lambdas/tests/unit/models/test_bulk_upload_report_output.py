...
def test_ods_report_populate_report_populates_successfully():
    expected = {
        ...
        "total_successful": {
            ("9000000000", "2012-01-13", "SUSPENDED"),
            ("9000000001", "2012-01-13", "DECEASED"),
            ("9000000002", "2012-01-13", "RESTRICTED"),
...
def test_summary_report_populate_report_populates_successfully():
    ...
    expected = {
        ...
        "total_successful": {
            ...
            ("9000000003", "2012-01-13", "True"),
            ("9000000004", "2012-01-13", "False"),
            ("9000000009", "2012-01-13", "SUSPENDED"),
            ("9000000010", "2012-01-13", "DECEASED"),
            ("9000000011", "2012-01-13", "RESTRICTED"),
