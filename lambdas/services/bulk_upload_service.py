...
class BulkUploadService:
    ...
    def copy_to_lg_bucket(self, source_file_key: str, dest_file_key: str):
        ...
        logger.info("Checking Copy Params:")
        logger.info("Staging Bucket Name: " + self.staging_bucket_name)
        logger.info("Source File Name: " + source_file_key)
        logger.info("LG Bucket Name: " + self.lg_bucket_name)
        logger.info("Destination File Name: " + dest_file_key)
