...
class UploadDocumentReferenceService:
    ...
    def handle_upload_document_reference_request(self, object_key: str):
        ...
        try:
            ...
            self._process_document_reference(document_reference, object_key)
    ...
    def update_dynamo_table(
        ...
        try:
            ...
            update_fields = {"virus_scanner_result", "doc_status", "file_location"}
