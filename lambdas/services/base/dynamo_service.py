...
class DynamoDBService:
    ...
    def get_table(self, table_name):
        try:
            ...
            logger.error(e, {"Result": "Unable to connect to DB"})
            raise e
    ...
    def query_with_requested_fields(
        ...
        try:
            ...
            logger.error(e, {"Result": "Unable to query table: {table_name}"})
            raise e
    ...
    def create_item(self, table_name, item):
        try:
            ...
            logger.error(e, {"Result": f"Unable to write item to table: {table_name}"})
            raise e
    ...
    def delete_item(self, table_name: str, key: dict):
        try:
            ...
            logger.error(e, {"Result": f"Unable to delete item in table: {table_name}"})
            logger.error(e)
            raise e
    ...
    def scan_table(
        ...
        try:
            ...
            logger.error(e, {"Result": f"Unable to scan table: {table_name}"})
            raise e
